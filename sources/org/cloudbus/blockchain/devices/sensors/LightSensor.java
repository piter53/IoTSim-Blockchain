...
public class LightSensor extends IoTBlockchainDevice {


	
	public LightSensor(EdgeNetworkInfo networkModel, String name, double bandwidth, BaseNode node, TransmissionPolicy transmissionPolicy) {
