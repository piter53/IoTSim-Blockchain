...
public class CarSensor extends IoTBlockchainDevice {
	
	public CarSensor(EdgeNetworkInfo networkModel, String name, double bandwidth, BaseNode node, TransmissionPolicy transmissionPolicy) {
